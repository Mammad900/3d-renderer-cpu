...
// void parseObject(shared_ptr<Scene> editingScene, std::ifstream &in, shared_ptr<Object> parent);
...
//     cout << "." << endl;
// }
// Material* findMaterial(string& name, shared_ptr<Scene> scene) {
...
//     return nullptr;
// }
// Mesh* findMesh(string& name, shared_ptr<Scene> scene) {
...
//     return nullptr;
// }
// shared_ptr<Scene> findScene(string& name) {
...
//                 string name, key;
//                 in >> name;
//                 shared_ptr<Volume> volume = std::make_shared<Volume>();
...
//                     MaterialFlags flags{};
//                     string key;
//                     shared_ptr<Volume> front = nullptr, back = nullptr;
//                     while (in >> key && key != "end") {
//                         if (key == "#") { while (in >> key && key != "#"); continue; }
...
//             string meshName;
//             in >> meshName;
//             obj->components.push_back(std::make_shared<MeshComponent>(obj.get(), findMesh(meshName, editingScene)));
//         }
//         else if(key == "light") {
//             string type;
//             Color color;
...
//             if (type == "directional") {
//                 light = std::make_shared<DirectionalLight>(obj.get(), color);
//             }
//             else if (type == "point") {
//                 light = std::make_shared<PointLight>(obj.get(), color);
//             }
//             else if (type == "spot") {
...
//                 shared_ptr<SpotLight> spotLight = std::make_shared<SpotLight>(obj.get(), color, spreadA, spreadB);
//                 light = spotLight;
...
//         }
//         else if(key == "camera") {
//             shared_ptr<Camera> cam = std::make_shared<Camera>(obj.get());
...
//             obj->components.push_back(std::make_shared<RotatorComponent>(obj.get(), rotatePerSecond));
//         }
//         else if(key == "keyboardControl") {
//             Vec3 speed;
//             bool scaleIsChildZ;
//             in >> speed >> scaleIsChildZ;
//             editingScene->keyboardControl = std::make_shared<KeyboardControlComponent>(obj.get(), speed, scaleIsChildZ);
